...
\addtolength{\textwidth}{1.50in} \addtolength{\textheight}{1.50in}
...
\address{
Mobile: 352-410-3713 \ \ \ \ \ Website: \url{www.obulpathi.com} \ \ \ \ \ Email:\href{mailto:obulpathi@gmail.com}{obulpathi@gmail.com}}
...
\\ {\bf Software:} Python, Go, Java, C, C++, Bash, HTML, JSON, Linux and UNIX
\\ {\bf Cloud:} Amazon AWS, Google Cloud, OpenStack, Docker, Fig, CoreOS, Salt, Heat
\\ {\bf Big Data:} Hadoop, HDFS, MapReduce, Hive, HBase, PigLatin, Spark, Storm, ZooKeeper, Sqoop, Mahout, Oozie, HCatalog, Ambari, Splunk, Elasticsearch
\\ {\bf Data Science:} ML, Statistics, Visualization, Analytics, Pandas, OpenNLP, NLTK
\\ {\bf Databases:} MySQL, NoSQL (Cassandra \& MongoDB), Redis, Neo4j
\\ {\bf Web Stack:} REST APIs, Django, Flask, Twisted
\\ {\bf Android:} Android
\\ {\bf Networks:} Computer, Wireless and Ad Hoc Networks, TCP/IP, 802.11, 802.15, NS3
\\ {\bf Messaging:} RabbitMQ, ZeroMQ, Kafka, Zaqar, Celery, Taskflow
\\ {\bf Python:} Requests, Fabric, NumPy, SciPy, Pillow, Matplotlib, Packaging, Sphinx, PyQT
\\ {\bf IOT:} Atmel AVR, PIC, ARM, Flash, EEPROM, Sensors, I2C, SPI, USART
\\ {\bf Security:} Computer, Network and Data Security, Bitcoin, Blockchain, Metaspoilt
\\ {\bf Others:} Git, CICD, Agile, JIRA, Kanban, Scrum, Hacking
