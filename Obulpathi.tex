...
\\ {\bf Software:} Python, Go, Java, Scala, C, C++, Bash, HTML, JSON, Linux and UNIX
\\ {\bf Cloud:} Amazon AWS, Google Cloud, OpenStack
\\ {\bf Big Data:} Spark, Flink, Druid, BigQuery, Dataflow, Hadoop, Pig, Hive, Sqoop
\\ {\bf Databases:} NoSQL, Cassandra, MongoDB, Redis, GraphX, Neo4j, MySQL, Google Datastore
\\ {\bf DevOps:} Ansible, Chef, CloudFormation, Docker, CoreOS, ELK Stack
\\ {\bf Web Stack:} Django, Flask, Bottle, Twisted, Jinja, Werkzeug
\\ {\bf Python:} Pandas, NumPy, SciPy, PyQT, Selenium, Fabric, Packaging, PEPs
\\ {\bf Java:} Core Java, Spring, Struts, JUnit, Swing, Servlets, Maven, Hibernate, JDBC
\\ {\bf Scala:} Akka, Play, Spray, Scalatra, Lift, sbt
\\ {\bf Go:} Go Kit, Circuit, NSQ, Revel, Gorilla, Bolt, Gofuzz, Standard libraries
\\ {\bf Data Science:} R, Julia, Scikit, ML, Neural Nets, Deep Learning, OpenNLP, NLTK, Tableau
...
\\ {\bf Security:} Kerberos, AD/LDAP, Bitcoin, Blockchain, Metaspoilt, Nmap
\\ {\bf Agile:} Agile, Kanban, Scrum, JIRA
\\ {\bf Others:} CICD, Hiring, Git, Android, Akka, ZooKeeper, CDN, DNS, Vim, Bootstrap, IntelliJ IDEA, Google Apps, Microservices, Containers, Scalability, High Availability, Small Satellites, Drones, Robotics
