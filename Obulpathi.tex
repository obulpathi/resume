...
$\bullet$ 5 years of experience in Hadoop and Big Data Technologies\\
$\bullet$ Good experience in product development and solutions in Big Data space\\
$\bullet$ Expertise on Real Time Data Streaming and Analytics projects\\
$\bullet$ Experience in Agile Engineering practices\\
$\bullet$ Significantly involved in Cloud automation, Logs processing and several Text processing tasks\\
$\bullet$ Providing solutions using Hadoop and its Ecosystem, Spark and its Ecosystem\\
$\bullet$ Experimented and Benchmarked several next generation data processing tools\\
$\bullet$ Worked in the area of Machine Learning, Text Mining, NLP, Analytics, and BigData\\
$\bullet$ Cassandra, MongoDB, Redis, Zookeeper, Akka\\
$\bullet$ Community\\
$\bullet$ Excellent  interpersonal  and  communication  skills,  creative,  research‐minded, technically competent and result oriented with problem solving and leadership skills
...
\\ {\bf Cloud:} Amazon AWS, Google Cloud, OpenStack, Docker, CoreOS, Kubernetes, Salt, Heat
\\ {\bf Big Data:} Spark, Storm, Hadoop, HDFS, MapReduce, PigLatin, Hive, HBase, HCatalog, Sqoop, Oozie, Falcon, Hue, Ambari, Splunk, Elasticsearch, Mahout, BigQuery, Akka, ZooKeeper
...
\\ {\bf Others:} Microservices, Containers, HA, Scalability, Git, CDN, Agile, Kanban, Scrum, JIRA, CICD, Jenkins, Travis CI, Nginx, Android, Small Satellites, Drones, Robotics, Ping Pong
...
\textbf{Cloud and Bid Data Architect for TIFAC (Volunteer)} \hfill 2015 - Current\\
Designed and developed CSD transport mechanism for synchronizing  Master and Slave databases. Implemented reliable asynchronous APIs for registration and database record transportation based on C++ Boost asio library and Google ProtoBuffers.\\
...
\textbf{Research and Teaching Assistant at University of Florida} \hfill 2009 - 2013\\
...
\textbf{Boltcoin \& Reversecoin } \hfill 2013 - Current\\
Created Bitcoinpy, a Python implementaiton of Bitcoin with focus on hackabilty and modulatiry. Analysed Bitcoin blockchain using Hadoop, Hive and Hbase.\\
\textbf{Bitcoinpy and Blockchain analysis} \hfill 2013 - 2014\\
