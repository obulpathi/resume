...
\\ {\bf Software:} Python, Go, C, C++, Java, Bash, HTML, JSON, Linux and UNIX
\\ {\bf Cloud:} Amazon AWS, Google Cloud, OpenStack, Docker, CoreOS, Salt, Heat 
\\ {\bf Big Data:} Hadoop, HDFS, MapReduce, Hive, HBase, PigLatin, Spark, Storm, ZooKeeper
\\ {\bf Data Science:} Machine Learning, Statistics, Visualization, Analytics, Pandas
\\ {\bf Web Stack:} REST APIs, MySQL, NoSQL (Cassandra \& MongoDB), Redis
\\ {\bf Android:} Android
...
\\ {\bf Python:} Django, Flask, Twisted, Fabric, NumPy, Scipy, Matplotlib, Packaging, Sphinx
