...
$\bullet$ Diverse background in Software, Hardware and Communications\\
$\bullet$ Good experience in product building and solutions in Cloud, Big Data  and Open Source space\\
$\bullet$ Experienced in Spark, Hadoop, Pig Latin, Hive, Cassandra, MongoDB, Redis, Zookeeper\\
$\bullet$ Worked in the area of Machine Learning, Text Mining, NLP, Analytics, and Big Data\\
$\bullet$ Experimented and benchmarked several next generation data processing tools\\
$\bullet$ Significantly involved in Cloud automation, logs processing using Big Data\\
$\bullet$ Expertise on real time data stream processing and analytics projects\\
$\bullet$ Streamlined Agile management using SCRUM, Kanban, CICD, Devops\\
$\bullet$ Good experience in team and community building in Cloud, Big Data and Open Source space\\
...
\\ {\bf Others:} Microservices, Containers, HA, Scalability, Git, Android, CDN, Agile, Kanban, Scrum, JIRA, CICD, Jenkins, Travis CI, Small Satellites, Drones, Robotics, Ping Pong
...
\textbf{Cloud, Big Data and Data Science Group of Atlanta} \hfill 2015 - Present\\
