...
\\ {\bf Python:}  NumPy, SciPy, Pillow, Matplotlib, PyQT, DB-API, Fabric, Packaging, Sphinx, PEP8
...
Designed and implemented ``CubeSat Cloud", a framework for distributed storage, processing and communication of remote sensing data using CubeSat Distributed File System (inspired by HDFS), CubeSat MapStich (like MapReduce) and CubeSat Torrent (inspired by Torrent) respectively.\\
