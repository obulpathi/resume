...
\\ {\bf Software:} Python, Go, Java, C, C++, Bash, HTML, JSON, XML, Linux and UNIX
...
\\ {\bf Databases:} MySQL, NoSQL (Cassandra \& MongoDB), Datastore, Redis, Neo4j
...
\\ {\bf Others:} Git, CICD, Agile, JIRA, Kanban, Scrum, Hacking, Android, Ping Pong
